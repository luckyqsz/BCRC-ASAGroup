...
from glob import glob  # search the matched files
...
# tf.trainable_variables(), 它能够将我们定义的所有的 trainable=True 的所有变量
# 以一个list的形式返回.
...
try:
    ...
    max_it = epoch * batch_epoch  # epoch is the specified training epoch
