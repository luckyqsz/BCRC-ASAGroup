...
for epoch in range(start_epoch, epochs):
    for i, (a_real, b_real) in enumerate(itertools.izip(a_loader, b_loader)):
        # zip是build-in方法, 而izip是itertools中的一个方法
        # 组合之后的元组长度是依照两个输入序列中最短的那个为准的
        # step
    ...
    utils.save_checkpoint({'epoch': epoch + 1,
                          ...
                          max_keep=2)
'''
Gs and Ds are trained sequentially, besides, real_images and fake_images are trained sequentially.
'''
