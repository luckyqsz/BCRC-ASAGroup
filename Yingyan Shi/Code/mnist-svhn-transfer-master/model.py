...
class G12(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        # encoding blocks
        self.conv1 = conv(1, conv_dim, 4)  # mnist is grayscale image
        ...
        self.deconv2 = deconv(conv_dim, 3, 4, bn=False)  # SVHN is 3-channel image
...
class D1(nn.Module):
    ...
    def __init__(self, conv_dim=64, use_labels=False):
        ...
        n_out = 11 if use_labels else 1  # unpaired image-to-image translation, use_labels=False
