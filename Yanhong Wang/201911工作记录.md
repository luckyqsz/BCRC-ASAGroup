...
* **Proposed method**
  ...
  ![1573096907196](201911工作记录.assets/1573096907196.png)

  FPN也就是使用了一个感知机，而且是单层的，但是就是用了一个跳级效果就很好，其实我觉得是因为跳级之前本来就是关键点坐标了，不管怎么样，结果还是很厉害的。看结构吧。

  ![1573096980474](201911工作记录.assets/1573096980474.png)
...
3.第三个特性是，我们需要满足一下这个式子： ![[公式]](201911工作记录.assets/equation.svg)

<<<<<<< HEAD
## <span id="11.2">20191118</span>
...
- **Proposed method:**
  ...
  ![1574159782583](201911工作记录.assets/1574159782583.png)
...
- **My views:**
  ...
  - 
>>>>>>> b417e78ca03c29e0c893a0e0cb74cd76537c3c61
